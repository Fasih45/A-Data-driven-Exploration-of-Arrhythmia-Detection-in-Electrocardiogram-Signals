...
def process_directory(directory, base_dir, result_base_dir):
    ...
    # records_file_path = f"D:\University\8th\ semester\Data\ Science\Assignment no 3\a-large-scale-12-lead-electrocardiogram-database-for-arrhythmia-study-1.0.0\WFDBRecords\01\010\RECORDS.txt"
